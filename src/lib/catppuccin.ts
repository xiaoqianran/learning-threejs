...
/** Three.js 课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "three-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "three-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Green，贴合 Three.js 紫 */
export const DEFAULT_CTP_ACCENT: CtpAccent = "lavender";
